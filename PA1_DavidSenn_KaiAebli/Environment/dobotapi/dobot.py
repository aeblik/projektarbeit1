...
class Dobot:
    ...
    def __init__(
        self, port: Optional[str] = None, execution_delay: float = 1
    ) -> None:
    ...
    def connect(self) -> bool:
        ...
        self._set_ptp_jump_params(25, 200)
    ...
    def move_to_Joint(
        ...
        z: float,
        r: float = 0.0,
        mode: MODE_PTP = MODE_PTP.MOVJ_XYZ,
        delay_overwrite: Optional[float] = None,
    ) -> Any:
        "Move robot to exact coordinates"
    ...
    def move_to_Jump(
        ...
        z: float,
        r: float = 0.0,
        mode: MODE_PTP = MODE_PTP.JUMP_XYZ,
        delay_overwrite: Optional[float] = None,
    ) -> Any:
        "Move robot to exact coordinates"
    ...
    def ir_toggle(self, enable: bool = True, port: GPIO = GPIO.PORT_GP2) -> Any:
    ...
    def get_ir(self, port: GPIO = GPIO.PORT_GP2) -> bool:
